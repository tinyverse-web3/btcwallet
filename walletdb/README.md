...
[![GoDoc](https://godoc.org/github.com/tinyverse-web3/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/tinyverse-web3/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/tinyverse-web3/btcwallet/walletdb

## Installation

```bash
$ go get github.com/tinyverse-web3/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/tinyverse-web3/btcwallet/walletdb#example-package--BasicUsage)  
